    ...
    def observe(
        ...
        for zr in range(self.zone_rows):
            for zc in range(self.zone_cols):
                r_start = zr * field_rows // self.zone_rows
                r_end = (zr + 1) * field_rows // self.zone_rows
                c_start = zc * field_cols // self.zone_cols
                c_end = (zc + 1) * field_cols // self.zone_cols
                ndvi_sum = 0.0
                count = 0
